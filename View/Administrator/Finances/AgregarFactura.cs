...
namespace YHDesign_project.View.Administrator.Finances
{
	public partial class AgregarFactura : Form
	{
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			dgv_detalle_factura.DataSource = find.GetFromDB($"SELECT ID_DET_FAC AS 'DETALLES FACTURAS', DEV_DET_FAC AS DEVOLUCION, " +
				$"ID_FAC AS FACTURA, ID_ART AS ARTICULO, CAN_ART_DET_FAC AS CANTIDAD, SUB_DET_FAC as SUBTOTAL, IMP_DET_FAC AS IMPUESTO, DES_DET_FAC AS DESCUENTO " +
				$"FROM detalles_facturas WHERE ID_FAC = 'FAC{codigoFactura}';");
		...
		private void button8_Click(object sender, EventArgs e)
		{
			...
			delete.UpdateFactura("DESACTIVAR", lbl_cod_factura.Text);
			this.Hide();
			codigoFactura++; 
			this.updateData.UpdateConfiguracion(
				2,
		...
		{
			ActulizarDetalesFacturasAgregar actulizarDetalesFacturasAgregar = new ActulizarDetalesFacturasAgregar();
			actulizarDetalesFacturasAgregar.Show();
		}
